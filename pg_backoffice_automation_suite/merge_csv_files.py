...
def merge_csv_files(base_folder):
    ...
    for file in csv_files:
        try:
            ...
            print(f"Error reading {file}: \033[31m{e}\033[0m")
    ...
    print(f"\033[32mAvailable CSV files in output-data-order-id are merged successfully into {merged_file_path}\033[0m")
