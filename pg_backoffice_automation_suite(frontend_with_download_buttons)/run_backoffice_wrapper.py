...
def run_backoffice_automation_with_logging(file_name, output_location, user_data_dir, chrome_binary, mode, output_log):
    ...
    try:
        # Capture the merged file path returned by the automation function
        merged_file_path = run_backoffice_automation(file_name, output_location, user_data_dir, chrome_binary, mode)
...
def run_backoffice_automation_batch_with_logging(file_name, output_location, user_data_dir, chrome_binary, mode, output_log):
    ...
    try:
        final_bi_folder = run_backoffice_automation_batch(file_name, output_location, user_data_dir, chrome_binary, mode)
        return final_bi_folder
    finally:
        builtins.print = original_print  # Restore original print
